...
{
    public class AddAppUserCommandValidator:AbstractValidator<AddAppUserCommand>
    {
        public AddAppUserCommandValidator()
        {
            ...
            RuleFor(x => x.CompanyId).NotEmpty().WithMessage("Company name is required.");
            ...
            RuleFor(y => y.ImageData).NotEmpty().WithMessage("Please choose a photo.");
